...
insert into USERS(email,username,pwd,fname,lname,plattinumUser)
	values('tanayssh@usc.edu','tshah','helloworld','tanay','shah',true),
		  ('avalante@usc.edu','avalante','swim','Alex', 'Valante',true),
          ('dshebib@usc.edu', 'dshebib','csci201', 'Daniel', 'Shebib',false),
          ('joex@usc.edu','joe','lol','Joe','x',false);
